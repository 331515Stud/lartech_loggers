...
class MainWindow(QMainWindow):
    ...
    def tile_subwindows(self, restore_50_50=False, resized_window=None, resize_from=None):
        """
        Tile subwindows based on layout mode, ensuring SignalsView and TrendsSubwindow resize inversely.
        """
        if self._resizing:
        ...
        try:
            ...
            middle_window = self.SignalsView_subwindow
            right_window = self.TrendsSubwindow

            # Ensure TrendsSubwindow is visible in both modes
