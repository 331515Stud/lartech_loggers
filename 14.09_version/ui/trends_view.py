...
class TrendsSubwindow(QMdiSubWindow):
    def __init__(self, parent=None):
        ...
        self.values_container.setStyleSheet("""
            QWidget {
                background-color: #353535;
                border: 1px solid #ccc;
                border-radius: 5px;
